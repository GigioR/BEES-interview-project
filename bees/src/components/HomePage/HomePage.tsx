    ...
    return (
        <LandingContentWrapper>
            <WelcomeContent>
                ...
                <InputAndButtonContainer>
                    <InputNameContainer data-testid="name-input" placeholder="Full name" onChange={(e) => handleSetName(e.target.value)} invalid={invalidUserName}></InputNameContainer>
                    <InputCheckboxText>
                        <InputCheckbox data-testid="check-box-input" type="checkbox" onChange={() => handleCheckboxState()} />
                        Are you older than 18 years old?
                    </InputCheckboxText>
                    <Link data-testid="link-to-list" to={"/brewery-list"}>
                        <EnterButton data-testid="enter-button" disabled={disabledButton} onClick={() => setUser({ userName: name })}>Enter</EnterButton>
                    </Link>
                </InputAndButtonContainer>
            </WelcomeContent>
            <BeeIcon src={BeeImg} />
